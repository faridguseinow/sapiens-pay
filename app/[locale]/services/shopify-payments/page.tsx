...
const content = {
  az: {
    ...
    packages: [
      ["Şirkətsiz quraşdırma", "Fərdi model", "$350", "$279", "20", ["Şirkət qeydiyyatı olmadan uyğunluq analizi", "Ayda təxminən $4–5K dövriyyəyə qədər tövsiyə olunan model", "Xarici bank hesabının açılması", "Mağaza və məhsul auditi", "Şəxsi məlumatlarla onboarding dəstəyi", "Verifikasiya və payout quraşdırması"]],
      ["Şirkət üzərindən quraşdırma", "Biznes model", "$450", "$349", "22", ["Rəsmi şirkət üzərindən Shopify Payments", "Şirkət və təsisçi sənədlərinin yoxlanması", "Mağaza uyğunluğu və siyasət səhifələrinin auditi", "Biznes verifikasiyasının müşayiəti", "Bank hesabı və payout bağlantısı", "Böyüyən əməliyyatlar üçün daha strukturlaşdırılmış model"]],
    ],
    note: "* Şirkət üzərindən paket üçün aktiv, rəsmi qeydiyyatdan keçmiş şirkət və korporativ sənədlər tələb olunur.",
    turnoverNote: "$4–5K aylıq dövriyyə şirkətsiz paket üçün Sapiens Pay-in tövsiyə etdiyi əməliyyat diapazonudur və Shopify tərəfindən müəyyən edilmiş rəsmi limit deyil.",
  ...
  ru: {
    ...
    packages: [
      ["Настройка без компании", "Индивидуальная модель", "$350", "$279", "20", ["Анализ возможности работы без регистрации компании", "Рекомендуемый диапазон оборота — до $4–5K в месяц", "Открытие зарубежного банковского счета", "Аудит магазина и товаров", "Поддержка онбординга на личные данные", "Верификация и настройка выплат"]],
      ["Настройка через компанию", "Бизнес-модель", "$450", "$349", "22", ["Shopify Payments через официальную компанию", "Проверка документов компании и учредителя", "Аудит магазина и политик", "Сопровождение бизнес-верификации", "Подключение банковского счета и выплат", "Структурированная модель для растущих операций"]],
    ],
    note: "* Для корпоративного пакета требуется действующая официально зарегистрированная компания и корпоративные документы.",
    turnoverNote: "$4–5K в месяц — рекомендуемый Sapiens Pay диапазон для пакета без компании, а не официальный лимит Shopify.",
  ...
  en: {
    ...
    packages: [
      ["Setup without a company", "Individual model", "$350", "$279", "20", ["Eligibility assessment without company registration", "Recommended for approximately up to $4–5K monthly turnover", "Foreign bank account setup", "Store and product audit", "Personal onboarding support", "Verification and payout setup"]],
      ["Company-based setup", "Business model", "$450", "$349", "22", ["Shopify Payments through a registered company", "Company and owner document review", "Store and policy audit", "Business verification support", "Bank-account and payout connection", "A structured model for growing operations"]],
    ],
    note: "* The company-based package requires an active, officially registered company and corporate documents.",
    turnoverNote: "$4–5K monthly turnover is Sapiens Pay’s recommended operating range for the no-company package, not an official Shopify limit.",
