...
const content = {
  az: {
    ...
    packages: [
      ["Wise Personal", "425 AZN", "253.30 AZN", "40", ["İlkin uyğunluq qiymətləndirməsi", "Şəxsi sənədlərin yoxlanması", "Qeydiyyat və onboarding dəstəyi", "Verifikasiya mərhələsi üzrə yönləndirmə", "Hesabdan istifadə üzrə təlimat"]],
      ["Wise Business", "680 AZN", "423.30 AZN", "38", ["Şirkət uyğunluğunun analizi", "Korporativ sənədlərin yoxlanması", "Biznes hesabı qeydiyyat dəstəyi", "Verifikasiya prosesinin müşayiəti", "Çoxvalyutalı rekvizit imkanları", "Hesabdan istifadə üzrə təlimat"]],
      ["Payoneer Business", "680 AZN", "423.30 AZN", "38", ["Şirkət və fəaliyyət modelinin analizi", "Sayt və sənədlərin ilkin auditi", "Biznes hesabı qeydiyyat dəstəyi", "Verifikasiya sənədlərinin hazırlanması", "Ödəniş rekvizitlərinin aktivləşdirilməsi", "Vəsait çıxarışı üzrə yönləndirmə"]],
    ],
  ...
  ru: {
    ...
    packages: [
      ["Wise Personal", "425 AZN", "253.30 AZN", "40", ["Предварительная оценка соответствия", "Проверка личных документов", "Поддержка регистрации и онбординга", "Сопровождение этапа верификации", "Инструкция по работе с аккаунтом"]],
      ["Wise Business", "680 AZN", "423.30 AZN", "38", ["Анализ соответствия компании", "Проверка корпоративных документов", "Поддержка регистрации бизнес-счета", "Сопровождение верификации", "Мультивалютные реквизиты", "Инструкция по работе с аккаунтом"]],
      ["Payoneer Business", "680 AZN", "423.30 AZN", "38", ["Анализ компании и бизнес-модели", "Предварительный аудит сайта и документов", "Поддержка регистрации бизнес-счета", "Подготовка к верификации", "Активация платежных реквизитов", "Рекомендации по выводу средств"]],
    ],
  ...
  en: {
    ...
    packages: [
      ["Wise Personal", "AZN 425", "AZN 253.30", "40", ["Initial eligibility assessment", "Personal document review", "Registration and onboarding support", "Verification-stage guidance", "Account usage instructions"]],
      ["Wise Business", "AZN 680", "AZN 423.30", "38", ["Company eligibility assessment", "Corporate document review", "Business-account registration support", "Verification support", "Multi-currency account details", "Account usage instructions"]],
      ["Payoneer Business", "AZN 680", "AZN 423.30", "38", ["Company and business-model assessment", "Initial website and document audit", "Business-account registration support", "Verification preparation", "Receiving-account activation", "Payout setup guidance"]],
    ],
